        ...
        SensitivePatterns {
            ...
            internal_tools: vec![
                ...
                CompiledPattern {
                    ...
                    regex: Regex::new(r#"https://[a-zA-Z0-9\-]+\.webhook\.office\.com/webhookb2/[a-f0-9\-]+@[a-f0-9\-]+/IncomingWebhook/[a-f0-9]+/[a-f0-9\-]+"#).unwrap(),
                    severity: Severity::High,
                    description: "Microsoft Teams incoming webhook URL - can post messages to internal channel without auth".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    name: "Google Chat Webhook".to_string(),
                    regex: Regex::new(r#"https://chat\.googleapis\.com/v1/spaces/[A-Za-z0-9_-]+/messages\?key=[A-Za-z0-9_-]+&token=[A-Za-z0-9%_\-]+"#).unwrap(),
                    severity: Severity::High,
                    description: "Google Chat webhook URL - can post messages to internal Space without auth".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    ...
                    severity: Severity::High,
                    description: "Mattermost incoming webhook URL - can post messages to internal channel".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    name: "PagerDuty Integration Key".to_string(),
                    regex: Regex::new(r#"https://events\.pagerduty\.com/(?:v2/enqueue|integration/[a-zA-Z0-9]+/enqueue)"#).unwrap(),
                    severity: Severity::Medium,
                    description: "PagerDuty integration endpoint referenced - integration key may be nearby".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Opsgenie Integration URL".to_string(),
                    regex: Regex::new(r#"https://api\.(?:eu\.)?opsgenie\.com/v2/alerts[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Opsgenie alert integration URL referenced".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Internal Prometheus URL".to_string(),
                    regex: Regex::new(r#"https?://prometheus[a-zA-Z0-9\-]*\.[a-zA-Z0-9\-]+\.[a-zA-Z]+[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Internal Prometheus URL found - metrics may leak infrastructure detail".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Internal Alertmanager URL".to_string(),
                    regex: Regex::new(r#"https?://alertmanager[a-zA-Z0-9\-]*\.[a-zA-Z0-9\-]+\.[a-zA-Z]+[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Internal Alertmanager URL found".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Internal Consul URL".to_string(),
                    regex: Regex::new(r#"https?://consul[a-zA-Z0-9\-]*\.[a-zA-Z0-9\-]+\.[a-zA-Z]+[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Internal HashiCorp Consul URL found - service catalog exposure".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Internal Vault URL".to_string(),
                    regex: Regex::new(r#"https?://vault[a-zA-Z0-9\-]*\.[a-zA-Z0-9\-]+\.[a-zA-Z]+[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Internal HashiCorp Vault URL found - secret manager exposure".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Internal Nomad URL".to_string(),
                    regex: Regex::new(r#"https?://nomad[a-zA-Z0-9\-]*\.[a-zA-Z0-9\-]+\.[a-zA-Z]+[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Internal HashiCorp Nomad URL found".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Internal Rancher URL".to_string(),
                    regex: Regex::new(r#"https?://rancher[a-zA-Z0-9\-]*\.[a-zA-Z0-9\-]+\.[a-zA-Z]+[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Internal Rancher URL found - K8s control plane".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Internal Portainer URL".to_string(),
                    regex: Regex::new(r#"https?://portainer[a-zA-Z0-9\-]*\.[a-zA-Z0-9\-]+\.[a-zA-Z]+[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Internal Portainer URL found - Docker/K8s control plane".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Internal Argo CD URL".to_string(),
                    regex: Regex::new(r#"https?://(?:argocd|argo-cd)\.[a-zA-Z0-9\-]+\.[a-zA-Z]+[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Internal Argo CD URL found - GitOps control plane".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Internal Airflow URL".to_string(),
                    regex: Regex::new(r#"https?://airflow[a-zA-Z0-9\-]*\.[a-zA-Z0-9\-]+\.[a-zA-Z]+[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Internal Airflow URL found - workflow orchestration".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Internal Metabase URL".to_string(),
                    regex: Regex::new(r#"https?://metabase[a-zA-Z0-9\-]*\.[a-zA-Z0-9\-]+\.[a-zA-Z]+[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Internal Metabase URL found - BI dashboards".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Internal Superset URL".to_string(),
                    regex: Regex::new(r#"https?://superset[a-zA-Z0-9\-]*\.[a-zA-Z0-9\-]+\.[a-zA-Z]+[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Internal Apache Superset URL found - BI dashboards".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Internal Retool URL".to_string(),
                    regex: Regex::new(r#"https?://[a-zA-Z0-9\-]+\.retool\.com[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Retool workspace URL found - internal apps/queries potentially exposed".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Internal Rundeck URL".to_string(),
                    regex: Regex::new(r#"https?://rundeck[a-zA-Z0-9\-]*\.[a-zA-Z0-9\-]+\.[a-zA-Z]+[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Internal Rundeck URL found - job/runbook execution engine".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Internal Vault Warden URL".to_string(),
                    regex: Regex::new(r#"https?://(?:vaultwarden|bitwarden)[a-zA-Z0-9\-]*\.[a-zA-Z0-9\-]+\.[a-zA-Z]+[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::High,
                    description: "Self-hosted Vaultwarden/Bitwarden URL found - password manager exposure".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Nexus/Artifactory URL".to_string(),
                    regex: Regex::new(r#"https?://(?:nexus|artifactory)[a-zA-Z0-9\-]*\.[a-zA-Z0-9\-]+\.[a-zA-Z]+[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Internal artifact repository URL found - build artifact/package exposure".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Harbor Registry URL".to_string(),
                    regex: Regex::new(r#"https?://harbor[a-zA-Z0-9\-]*\.[a-zA-Z0-9\-]+\.[a-zA-Z]+[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Harbor container registry URL found".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Internal Sentry URL".to_string(),
                    regex: Regex::new(r#"https?://sentry\.[a-zA-Z0-9\-]+\.[a-zA-Z]+[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Self-hosted Sentry URL found - crash reports may include PII/tokens".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Sentry DSN".to_string(),
                    regex: Regex::new(r#"https://[a-f0-9]{32}@[a-zA-Z0-9\-.]+/\d+"#).unwrap(),
                    severity: Severity::Low,
                    description: "Sentry DSN URL - public keys grant event-ingest ability that can be abused".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Internal Splunk URL".to_string(),
                    regex: Regex::new(r#"https?://splunk[a-zA-Z0-9\-]*\.[a-zA-Z0-9\-]+\.[a-zA-Z]+[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Internal Splunk URL found - log platform exposure".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Internal Elasticsearch URL".to_string(),
                    regex: Regex::new(r#"https?://(?:elastic|elasticsearch|es-cluster|opensearch)[a-zA-Z0-9\-]*\.[a-zA-Z0-9\-]+\.[a-zA-Z]+[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Internal Elasticsearch/OpenSearch URL found".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Internal RabbitMQ Management URL".to_string(),
                    regex: Regex::new(r#"https?://rabbit(?:mq)?[a-zA-Z0-9\-]*\.[a-zA-Z0-9\-]+\.[a-zA-Z]+[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Internal RabbitMQ management URL found".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Internal Kafka UI URL".to_string(),
                    regex: Regex::new(r#"https?://(?:kafka-ui|kafka|akhq)\.[a-zA-Z0-9\-]+\.[a-zA-Z]+[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Internal Kafka UI URL found - topic/message exposure".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Internal Redis Insight URL".to_string(),
                    regex: Regex::new(r#"https?://(?:redisinsight|redis-insight|redis-commander)\.[a-zA-Z0-9\-]+\.[a-zA-Z]+[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Internal Redis management URL found".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "OpenShift Console URL".to_string(),
                    regex: Regex::new(r#"https?://console-openshift-console\.apps\.[a-zA-Z0-9\-.]+[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "OpenShift console URL found".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Kubernetes Dashboard URL".to_string(),
                    regex: Regex::new(r#"https?://k8s(?:-dashboard)?\.[a-zA-Z0-9\-]+\.[a-zA-Z]+[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Kubernetes dashboard URL found".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Jaeger Tracing URL".to_string(),
                    regex: Regex::new(r#"https?://jaeger[a-zA-Z0-9\-]*\.[a-zA-Z0-9\-]+\.[a-zA-Z]+[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Internal Jaeger tracing UI found - trace data may leak internal service topology".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Buildkite Pipeline URL".to_string(),
                    regex: Regex::new(r#"https://buildkite\.com/[a-zA-Z0-9\-]+/[a-zA-Z0-9\-]+"#).unwrap(),
                    severity: Severity::Low,
                    description: "Buildkite pipeline URL found - private pipeline reference".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "CircleCI Project URL".to_string(),
                    regex: Regex::new(r#"https://(?:app\.)?circleci\.com/pipelines/(?:github|gitlab|bitbucket)/[a-zA-Z0-9\-]+/[a-zA-Z0-9\-]+"#).unwrap(),
                    severity: Severity::Low,
                    description: "CircleCI project pipeline URL found".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "TeamCity Internal URL".to_string(),
                    regex: Regex::new(r#"https?://teamcity[a-zA-Z0-9\-]*\.[a-zA-Z0-9\-]+\.[a-zA-Z]+[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Internal TeamCity URL found - CI system exposure".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Nexus Repository UI".to_string(),
                    regex: Regex::new(r#"https?://[a-zA-Z0-9\-.]+/(?:nexus/#browse|service/rest/v1/repositories)[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Nexus repository endpoint referenced".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "OneLogin/Okta App URL".to_string(),
                    regex: Regex::new(r#"https://[a-zA-Z0-9\-]+\.(?:okta|onelogin)\.com/(?:app|admin)/[^\s\"'<>]+"#).unwrap(),
                    severity: Severity::Medium,
                    description: "IdP internal app URL leaked - tenant name confirmed".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "AWS Console Deep Link".to_string(),
                    regex: Regex::new(r#"https://[a-z0-9\-]+\.signin\.aws\.amazon\.com/[^\s\"'<>]+|https://console\.aws\.amazon\.com/[a-z0-9]+/(?:home|v[0-9]+)[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Low,
                    description: "AWS console URL - may leak account alias/region".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "GCP Console Deep Link".to_string(),
                    regex: Regex::new(r#"https://console\.cloud\.google\.com/[^\s\"'<>]*[?&]project=[a-z][a-z0-9\-]{4,28}[a-z0-9]"#).unwrap(),
                    severity: Severity::Low,
                    description: "GCP console URL - leaks project ID".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Azure Portal Deep Link".to_string(),
                    regex: Regex::new(r#"https://portal\.azure\.com/#(?:@[a-zA-Z0-9\-.]+/)?resource/subscriptions/[a-f0-9\-]{36}/[^\s\"'<>]+"#).unwrap(),
                    severity: Severity::Low,
                    description: "Azure portal URL - leaks tenant/subscription ID".to_string(),
                    cwe: "CWE-200".to_string(),
                },
            ],
            ...
            environment_patterns: vec![
                ...
                CompiledPattern {
                    ...
                    regex: Regex::new(r#"jdbc:(?:mysql|postgresql|oracle:thin|sqlserver|db2|mariadb|redshift|snowflake)://[^\s\"'<>]+"#).unwrap(),
                    severity: Severity::Critical,
                    description: "JDBC connection string exposed - may include host, DB, and credentials".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    name: "SQL Server ADO Connection".to_string(),
                    regex: Regex::new(r#"(?i)(?:Data Source|Server)=[^;\"']+;\s*(?:Initial Catalog|Database)=[^;\"']+;\s*(?:User Id|UID)=[^;\"']+;\s*(?:Password|PWD)=[^;\"']+"#).unwrap(),
                    severity: Severity::Critical,
                    description: "SQL Server ADO/OLE-DB connection string with credentials found".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    name: "MongoDB SRV with Credentials".to_string(),
                    regex: Regex::new(r#"mongodb\+srv://[^:\s]+:[^@\s]+@[a-zA-Z0-9\-.]+/[^\s\"'<>?]+"#).unwrap(),
                    severity: Severity::Critical,
                    description: "MongoDB SRV URI with embedded credentials".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    name: "Kafka Bootstrap Servers".to_string(),
                    regex: Regex::new(r#"(?i)(?:bootstrap[_-]?servers|kafka[_-]?brokers)\s*[=:]\s*['\"][a-zA-Z0-9\-.,:]{10,}['\"]"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Kafka bootstrap server list exposed - may reveal internal topology".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "SMTP Credentials".to_string(),
                    regex: Regex::new(r#"smtps?://[^:\s]+:[^@\s]+@[a-zA-Z0-9\-.]+:[0-9]{2,5}"#).unwrap(),
                    severity: Severity::Critical,
                    description: "SMTP URL with embedded credentials found".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    name: "FTP with Credentials".to_string(),
                    regex: Regex::new(r#"s?ftp://[^:\s/]+:[^@\s]+@[a-zA-Z0-9\-.]+[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Critical,
                    description: "FTP/SFTP URL with embedded credentials found".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    name: "AWS S3 Presigned URL".to_string(),
                    regex: Regex::new(r#"https?://[a-zA-Z0-9\-.]+\.s3[.\-][a-z0-9\-]+\.amazonaws\.com/[^\s\"'<>?]+\?[^\s\"'<>]*X-Amz-Signature=[a-f0-9]{64}"#).unwrap(),
                    severity: Severity::High,
                    description: "AWS S3 presigned URL exposed - grants direct object access until expiry".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "GCS Signed URL".to_string(),
                    regex: Regex::new(r#"https://storage\.googleapis\.com/[^\s\"'<>?]+\?[^\s\"'<>]*X-Goog-Signature=[a-f0-9]{64,}"#).unwrap(),
                    severity: Severity::High,
                    description: "GCS signed URL exposed - grants direct object access until expiry".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "AWS Role ARN".to_string(),
                    regex: Regex::new(r#"arn:aws:iam::\d{12}:role/[a-zA-Z0-9+=,.@\-_/]+"#).unwrap(),
                    severity: Severity::Low,
                    description: "AWS IAM role ARN exposed - reveals account ID and role name".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "AWS Account ID Reference".to_string(),
                    regex: Regex::new(r#"(?i)(?:aws[_-]?account[_-]?id|account[_-]?number)\s*[=:]\s*['\"]?\d{12}['\"]?"#).unwrap(),
                    severity: Severity::Low,
                    description: "AWS account ID exposed - useful for account-targeted phishing/enumeration".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "GCP Service Account Email".to_string(),
                    regex: Regex::new(r#"[a-zA-Z0-9\-]+@[a-z][a-z0-9\-]{4,28}[a-z0-9]\.iam\.gserviceaccount\.com"#).unwrap(),
                    severity: Severity::Low,
                    description: "GCP service account email exposed - reveals project ID and SA name".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Azure Subscription ID".to_string(),
                    regex: Regex::new(r#"(?i)(?:subscriptionid|subscription[_-]id)\s*[=:]\s*['\"]?[a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12}['\"]?"#).unwrap(),
                    severity: Severity::Low,
                    description: "Azure subscription ID exposed".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Azure Tenant ID".to_string(),
                    regex: Regex::new(r#"(?i)(?:tenantid|tenant[_-]id|directory[_-]id)\s*[=:]\s*['\"]?[a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12}['\"]?"#).unwrap(),
                    severity: Severity::Low,
                    description: "Azure/Entra tenant ID exposed - enables tenant enumeration".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "AWS IMDS Reference".to_string(),
                    regex: Regex::new(r#"http://169\.254\.169\.254/(?:latest|1\.0|2018-\d{2}-\d{2})/(?:meta-data|user-data|dynamic|api)[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::High,
                    description: "Cloud instance metadata endpoint referenced client-side - possible SSRF vector".to_string(),
                    cwe: "CWE-918".to_string(),
                },
                CompiledPattern {
                    name: "GCP Metadata Reference".to_string(),
                    regex: Regex::new(r#"http://metadata\.google\.internal/computeMetadata/v1/[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::High,
                    description: "GCP metadata endpoint referenced client-side - possible SSRF vector".to_string(),
                    cwe: "CWE-918".to_string(),
                },
                CompiledPattern {
                    name: "K8s API Server Reference".to_string(),
                    regex: Regex::new(r#"https://kubernetes\.default\.svc(?:\.cluster\.local)?(?:/api|:443)[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Kubernetes in-cluster API server reference - confirms K8s deployment".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Docker Socket Reference".to_string(),
                    regex: Regex::new(r#"(?:/var/run/docker\.sock|unix:///var/run/docker\.sock|tcp://[a-zA-Z0-9\-.]+:2375)"#).unwrap(),
                    severity: Severity::High,
                    description: "Docker socket reference - remote 2375 is often unauthed / socket exposure = RCE".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Elasticsearch REST Endpoint".to_string(),
                    regex: Regex::new(r#"https?://[a-zA-Z0-9\-.]+:9200(?:/_cat|/_cluster|/_search)[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Elasticsearch REST endpoint referenced - may indicate direct DB access".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Prometheus Federate/Query".to_string(),
                    regex: Regex::new(r#"https?://[a-zA-Z0-9\-.]+(?::9090)?/(?:api/v1/(?:query|targets|series|label)|federate)\?[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Prometheus query/federate endpoint referenced".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Node exporter Endpoint".to_string(),
                    regex: Regex::new(r#"https?://[a-zA-Z0-9\-.]+:9100/metrics"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Prometheus node_exporter endpoint referenced - leaks host detail".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Spring Actuator Endpoint".to_string(),
                    regex: Regex::new(r#"[\"'](/actuator/(?:env|configprops|heapdump|threaddump|beans|mappings|health/[a-z]+|metrics|shutdown))[\"']"#).unwrap(),
                    severity: Severity::High,
                    description: "Spring Boot actuator endpoint referenced - env/heapdump/shutdown are critical exposure".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Django Admin URL".to_string(),
                    regex: Regex::new(r#"[\"'](/admin/(?:login|password_reset|jsi18n)[/?][^\s\"'<>]*)[\"']"#).unwrap(),
                    severity: Severity::Low,
                    description: "Django admin URL referenced".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Rails Development Web Console".to_string(),
                    regex: Regex::new(r#"[\"'](/rails/(?:info|conductor|db|active_storage)[/?][^\s\"'<>]*)[\"']"#).unwrap(),
                    severity: Severity::High,
                    description: "Rails development route referenced - should never ship to production".to_string(),
                    cwe: "CWE-489".to_string(),
                },
                CompiledPattern {
                    name: ".env File Reference".to_string(),
                    regex: Regex::new(r#"[\"'](/\.env(?:\.[a-zA-Z]+)?(?:\?[^\s\"'<>]*)?)[\"']"#).unwrap(),
                    severity: Severity::High,
                    description: "Reference to .env file path in client code - likely exposure".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Source Map Reference".to_string(),
                    regex: Regex::new(r#"//[#@]\s+sourceMappingURL=(?:https?:)?//[^\s\"'<>]+\.map"#).unwrap(),
                    severity: Severity::Low,
                    description: "Absolute sourceMappingURL - may expose full source tree if map file is fetched".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "GraphQL Endpoint".to_string(),
                    regex: Regex::new(r#"[\"'](/graphql[a-z]*(?:/[^\s\"'<>]*)?)[\"']"#).unwrap(),
                    severity: Severity::Info,
                    description: "GraphQL endpoint path referenced - check for introspection".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "WordPress XML-RPC".to_string(),
                    regex: Regex::new(r#"[\"'](/xmlrpc\.php)[\"']"#).unwrap(),
                    severity: Severity::Medium,
                    description: "WordPress XML-RPC endpoint referenced - common brute-force/DDoS surface".to_string(),
                    cwe: "CWE-200".to_string(),
                },
            ],
