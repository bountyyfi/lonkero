    ...
    fn build_patterns() -> SensitivePatterns {
        SensitivePatterns {
            ...
            credential_patterns: vec![
                ...
                // --- AI provider tokens ---
                // All have vendor-specific prefixes that cannot occur incidentally,
                // making real matches near-impossible to be false positives.
                CompiledPattern {
                    name: "OpenAI Project API Key".to_string(),
                    regex: Regex::new(r#"sk-proj-[A-Za-z0-9_\-]{40,}"#).unwrap(),
                    severity: Severity::Critical,
                    description: "OpenAI project-scoped API key found - billing abuse and data access risk".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    ...
                    severity: Severity::Critical,
                    description: "OpenAI service account key found - non-rotating credential, full org access".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    name: "Anthropic API Key (api03)".to_string(),
                    regex: Regex::new(r#"sk-ant-api03-[A-Za-z0-9_\-]{40,}"#).unwrap(),
                    severity: Severity::Critical,
                    description: "Anthropic API key (api03) found - billing abuse and Claude API access".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    name: "Anthropic Admin Key".to_string(),
                    regex: Regex::new(r#"sk-ant-admin01-[A-Za-z0-9_\-]{40,}"#).unwrap(),
                    severity: Severity::Critical,
                    description: "Anthropic admin key found - full organization administrative access".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    ...
                    severity: Severity::Critical,
                    description: "xAI (Grok) API key found - billing abuse risk".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    ...
                    severity: Severity::Critical,
                    description: "GroqCloud API key found - billing abuse risk".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    ...
                    severity: Severity::Critical,
                    description: "Perplexity API key found - billing abuse risk".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    ...
                    severity: Severity::Critical,
                    description: "Replicate API token found - model inference billing abuse".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    ...
                    severity: Severity::High,
                    description: "Hugging Face access token found - may grant model and dataset access".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    name: "Together AI API Key".to_string(),
                    regex: Regex::new(r#"tgp_v1_[A-Za-z0-9_\-]{40,}"#).unwrap(),
                    severity: Severity::Critical,
                    description: "Together AI API key found - inference billing abuse risk".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    name: "Pinecone API Key".to_string(),
                    regex: Regex::new(r#"pcsk_[A-Za-z0-9_]{40,}"#).unwrap(),
                    severity: Severity::Critical,
                    description: "Pinecone vector database API key found - full index access".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    name: "Fireworks AI API Key".to_string(),
                    // Real Fireworks keys are 24+ continuous alphanumerics after fw_.
                    // Require quote/assignment context to avoid matching "fw_X..." variable names.
                    regex: Regex::new(r#"['"=:\s]fw_[A-Za-z0-9]{24,}['"\s,;}\]]"#).unwrap(),
                    severity: Severity::Critical,
                    description: "Fireworks AI API key found - inference billing abuse risk".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                // --- Supply-chain / artifact-store tokens (high blast radius) ---
                CompiledPattern {
                    name: "JFrog Artifactory API Key".to_string(),
                    regex: Regex::new(r#"AKCp[A-Za-z0-9]{69,71}"#).unwrap(),
                    severity: Severity::Critical,
                    description: "JFrog Artifactory API key found - artifact tampering and supply-chain risk".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    name: "JFrog Access Token".to_string(),
                    regex: Regex::new(r#"eyJ2ZXIiOiIyIiwidHlwIjoiSldUIiwiYWxnIjoiUlMyNTYi[A-Za-z0-9_\-]{10,}"#).unwrap(),
                    severity: Severity::Critical,
                    description: "JFrog Access scoped token found".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                ...
                // --- Other modern provider tokens with unique prefixes ---
                CompiledPattern {
                    name: "Brevo/Sendinblue API Key".to_string(),
                    regex: Regex::new(r#"xkeysib-[a-f0-9]{64}-[A-Za-z0-9]{16}"#).unwrap(),
                    severity: Severity::Critical,
                    description: "Brevo (formerly Sendinblue) API key found - allows sending email from the tenant".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    name: "AWS AppSync API Key".to_string(),
                    regex: Regex::new(r#"da2-[a-z0-9]{26}"#).unwrap(),
                    severity: Severity::High,
                    description: "AWS AppSync (GraphQL) API key found - direct GraphQL API access".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    name: "Render API Key".to_string(),
                    // Render keys appear as rnd_<28 alphanum>; require assignment context to
                    // avoid accidental matches against variable names ending in rnd_*.
                    regex: Regex::new(r#"['"=:\s]rnd_[A-Za-z0-9]{20,}['"\s,;}\]]"#).unwrap(),
                    severity: Severity::Critical,
                    description: "Render.com API key found - service deployment access".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    name: "Fly.io API Token".to_string(),
                    regex: Regex::new(r#"FlyV1\s[A-Za-z0-9_\-]{80,}"#).unwrap(),
                    severity: Severity::Critical,
                    description: "Fly.io API token found - deployment access".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    ...
                    severity: Severity::Critical,
                    description: "Stytch authentication secret found - user identity provider access".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    name: "Tailscale Auth Key".to_string(),
                    regex: Regex::new(r#"tskey-auth-[A-Za-z0-9_\-]{20,}-[A-Za-z0-9]{20,}"#).unwrap(),
                    severity: Severity::Critical,
                    description: "Tailscale auth key found - allows joining the tailnet".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    name: "Tailscale API Key".to_string(),
                    regex: Regex::new(r#"tskey-api-[A-Za-z0-9_\-]{20,}-[A-Za-z0-9]{20,}"#).unwrap(),
                    severity: Severity::Critical,
                    description: "Tailscale API key found - full tailnet administrative access".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    name: "AWS Session Token (ASIA)".to_string(),
                    regex: Regex::new(r#"ASIA[0-9A-Z]{16}"#).unwrap(),
                    severity: Severity::High,
                    description: "AWS STS temporary access key (ASIA prefix) found - active until expiry, often valid for hours".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    ...
                    severity: Severity::Critical,
                    description: "Discord bot token found - full bot control and guild access".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    name: "Slack User Token".to_string(),
                    regex: Regex::new(r#"xox[baprs]-[0-9]{10,13}-[0-9]{10,13}-[0-9]{10,13}-[a-f0-9]{32,}"#).unwrap(),
                    severity: Severity::Critical,
                    description: "Slack token (bot/user/app/refresh) found - workspace access".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    name: "Slack Workflow Webhook".to_string(),
                    regex: Regex::new(r#"https://hooks\.slack\.com/triggers/T[A-Z0-9]+/[0-9]+/[A-Za-z0-9]+"#).unwrap(),
                    severity: Severity::High,
                    description: "Slack workflow trigger webhook found - allows triggering internal workflows".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    name: "Mux Token Secret".to_string(),
                    regex: Regex::new(r#"(?i)mux[_-]?token[_-]?secret\s*[=:]\s*['\"][A-Za-z0-9+/=]{75,}['\"]"#).unwrap(),
                    severity: Severity::High,
                    description: "Mux.com video API secret found".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    name: "Square Application Secret".to_string(),
                    regex: Regex::new(r#"sq0idp-[A-Za-z0-9_\-]{43}"#).unwrap(),
                    severity: Severity::Critical,
                    description: "Square application ID/secret pair found".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    ...
                    severity: Severity::Critical,
                    description: "PyPI API token found - package publish/supply-chain risk".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    name: "Adobe IMS Refresh Token".to_string(),
                    regex: Regex::new(r#"eyJ4NXUiOiJpbXNfbmExLXN0ZzEta2V5LTEiLCJhbGciOiJSUzI1NiJ9\.eyJ[A-Za-z0-9_\-]{10,}\.[A-Za-z0-9_\-]{10,}"#).unwrap(),
                    severity: Severity::Critical,
                    description: "Adobe IMS staging/JWT token found".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    name: "Algolia Application API Key".to_string(),
                    regex: Regex::new(r#"(?i)x-algolia-(?:admin-|api-)?api-key['\"]?\s*[:=]\s*['\"][a-f0-9]{32}['\"]"#).unwrap(),
                    severity: Severity::Critical,
                    description: "Algolia API key referenced via x-algolia-api-key header - admin key allows index modification".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    name: "Sentry Internal Integration Token".to_string(),
                    regex: Regex::new(r#"sntryu_[A-Za-z0-9]{40,}"#).unwrap(),
                    severity: Severity::Critical,
                    description: "Sentry internal integration token found - org-scoped access".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    ...
                    severity: Severity::High,
                    description: "Figma personal access token found - design file access".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    name: "Asana Personal Access Token (v2)".to_string(),
                    regex: Regex::new(r#"2/[0-9]{16}/[0-9]{16}:[a-f0-9]{32}"#).unwrap(),
                    severity: Severity::High,
                    description: "Asana v2 personal access token found".to_string(),
                    cwe: "CWE-798".to_string(),
                },
            ],
