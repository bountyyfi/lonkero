    ...
    fn build_patterns() -> SensitivePatterns {
        SensitivePatterns {
            ...
            credential_patterns: vec![
                ...
                // Additional structurally-unique vendor tokens. Each prefix is
                // issued exclusively by the named provider, so a regex match is a
                // live credential rather than a coincidental string.
                CompiledPattern {
                    name: "Slack Token".to_string(),
                    regex: Regex::new(r#"xox[baprs]-[0-9]{10,13}-[0-9]{10,13}-[a-zA-Z0-9]{24,}"#).unwrap(),
                    severity: Severity::Critical,
                    description: "Slack bot/user/workspace token found - grants Slack API access to the workspace".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    name: "Slack App-Level Token".to_string(),
                    regex: Regex::new(r#"xapp-1-[A-Z0-9]+-[0-9]+-[a-zA-Z0-9]+"#).unwrap(),
                    severity: Severity::Critical,
                    description: "Slack app-level token found - enables Socket Mode and app-wide API access".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    ...
                    severity: Severity::Critical,
                    description: "Stripe webhook signing secret found - allows forging valid Stripe webhook events".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    ...
                    severity: Severity::Critical,
                    description: "OpenAI project-scoped API key found - allows billable API usage on the account".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    ...
                    severity: Severity::High,
                    description: "Figma personal access token found - grants API access to the user's Figma files".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    ...
                    severity: Severity::Critical,
                    description: "RubyGems API key found - allows publishing/yanking gems (supply-chain risk)".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    ...
                    severity: Severity::Critical,
                    description: "Databricks personal access token found - grants access to workspaces, jobs, and data".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    ...
                    severity: Severity::High,
                    description: "Grafana service account token found - grants API access to dashboards and data sources".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    name: "Clojars Deploy Token".to_string(),
                    regex: Regex::new(r#"CLOJARS_[a-zA-Z0-9]{60}"#).unwrap(),
                    severity: Severity::Critical,
                    description: "Clojars deploy token found - allows publishing Clojure packages (supply-chain risk)".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    name: "EasyPost API Key".to_string(),
                    regex: Regex::new(r#"EZ[AT]K[a-zA-Z0-9]{50,}"#).unwrap(),
                    severity: Severity::High,
                    description: "EasyPost API key found - grants access to shipping accounts and label generation".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    ...
                    severity: Severity::High,
                    description: "Adafruit IO key found - grants control over connected IoT feeds and devices".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    name: "Notion Integration Token".to_string(),
                    regex: Regex::new(r#"ntn_[a-zA-Z0-9]{36,}"#).unwrap(),
                    severity: Severity::High,
                    description: "Notion integration token found - grants API access to connected Notion workspaces".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    ...
                    severity: Severity::Critical,
                    description: "Tailscale auth key found - allows joining arbitrary devices to the private network".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    ...
                    severity: Severity::High,
                    description: "Sentry user auth token found - grants API access to projects, issues, and source maps".to_string(),
                    cwe: "CWE-798".to_string(),
                },
            ],
