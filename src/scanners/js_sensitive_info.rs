    ...
    fn build_patterns() -> SensitivePatterns {
        SensitivePatterns {
            ...
            internal_tools: vec![
                ...
                // Observability / logging / APM platforms. Each pattern requires a
                // vendor-specific subdomain or the vendor's apex so a marketing link
                // (e.g. "datadoghq.com/blog") cannot match.
                CompiledPattern {
                    name: "Datadog Customer URL".to_string(),
                    regex: Regex::new(r#"https?://(?:app|api|http-intake|logs|dd)\.(?:datadoghq\.com|datadoghq\.eu|us3\.datadoghq\.com|us5\.datadoghq\.com|ap1\.datadoghq\.com)/[^\s\"'<>]+"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Datadog tenant URL exposed — may reveal observability/APM endpoints".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "New Relic Customer URL".to_string(),
                    regex: Regex::new(r#"https?://(?:one|api|insights-collector|log-api|infra-api)\.(?:newrelic\.com|eu\.newrelic\.com)/[^\s\"'<>]+"#).unwrap(),
                    severity: Severity::Medium,
                    description: "New Relic tenant URL exposed — may reveal APM ingestion endpoints".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Splunk Cloud URL".to_string(),
                    regex: Regex::new(r#"https?://[a-zA-Z0-9\-]+\.splunkcloud\.com[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Splunk Cloud tenant URL exposed".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Splunk On-Premise URL".to_string(),
                    regex: Regex::new(r#"https?://splunk\.[a-zA-Z0-9\-]+\.[a-zA-Z]+[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Self-hosted Splunk URL exposed".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    ...
                    severity: Severity::Medium,
                    description: "Self-hosted Sentry URL exposed — likely internal error tracker".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "PagerDuty Subdomain".to_string(),
                    regex: Regex::new(r#"https?://[a-zA-Z0-9\-]+\.pagerduty\.com/[^\s\"'<>]+"#).unwrap(),
                    severity: Severity::Medium,
                    description: "PagerDuty tenant URL exposed — reveals on-call/incident infra".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Bugsnag Project URL".to_string(),
                    regex: Regex::new(r#"https?://app\.bugsnag\.com/[a-zA-Z0-9\-]+/[a-zA-Z0-9\-]+[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Bugsnag project URL exposed".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Rollbar Project URL".to_string(),
                    regex: Regex::new(r#"https?://rollbar\.com/[a-zA-Z0-9_\-]+/[a-zA-Z0-9_\-]+[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Rollbar project URL exposed".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Honeycomb Tenant URL".to_string(),
                    regex: Regex::new(r#"https?://ui\.honeycomb\.io/[a-zA-Z0-9_\-]+[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Honeycomb tenant URL exposed".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "LaunchDarkly Project URL".to_string(),
                    regex: Regex::new(r#"https?://app\.launchdarkly\.com/[a-zA-Z0-9_\-]+/[a-zA-Z0-9_\-]+[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "LaunchDarkly project URL exposed — reveals feature flag administration paths".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    ...
                    severity: Severity::Medium,
                    description: "JetBrains TeamCity CI URL exposed".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "CircleCI Pipeline URL".to_string(),
                    regex: Regex::new(r#"https?://app\.circleci\.com/(?:pipelines|projects|jobs)/[a-zA-Z0-9_\-/]+[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "CircleCI pipeline/project URL exposed".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Argo CD URL".to_string(),
                    regex: Regex::new(r#"https?://argocd\.[a-zA-Z0-9\-]+\.[a-zA-Z]+[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Argo CD continuous-deployment UI exposed".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Vault URL".to_string(),
                    regex: Regex::new(r#"https?://vault\.[a-zA-Z0-9\-]+\.[a-zA-Z]+[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::High,
                    description: "HashiCorp Vault URL exposed — direct path to secret store".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    ...
                    severity: Severity::Medium,
                    description: "HashiCorp Consul URL exposed — reveals service mesh control plane".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    ...
                    severity: Severity::Medium,
                    description: "HashiCorp Nomad URL exposed — reveals scheduler UI".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    ...
                    severity: Severity::Medium,
                    description: "Rancher Kubernetes management URL exposed".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Portainer URL".to_string(),
                    regex: Regex::new(r#"https?://portainer\.[a-zA-Z0-9\-]+\.[a-zA-Z]+[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Portainer Docker/Kubernetes management UI exposed".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Nexus Repository URL".to_string(),
                    regex: Regex::new(r#"https?://nexus\.[a-zA-Z0-9\-]+\.[a-zA-Z]+[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Sonatype Nexus artifact repository exposed".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Artifactory URL".to_string(),
                    regex: Regex::new(r#"https?://(?:artifactory|jfrog)\.[a-zA-Z0-9\-]+\.[a-zA-Z]+[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "JFrog Artifactory URL exposed — likely internal artifact registry".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "MinIO Console URL".to_string(),
                    regex: Regex::new(r#"https?://minio\.[a-zA-Z0-9\-]+\.[a-zA-Z]+[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "MinIO object storage URL exposed".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Airflow URL".to_string(),
                    regex: Regex::new(r#"https?://airflow\.[a-zA-Z0-9\-]+\.[a-zA-Z]+[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Apache Airflow orchestrator URL exposed".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Superset URL".to_string(),
                    regex: Regex::new(r#"https?://superset\.[a-zA-Z0-9\-]+\.[a-zA-Z]+[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Apache Superset BI URL exposed".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    ...
                    severity: Severity::Medium,
                    description: "Metabase BI dashboard URL exposed".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Looker URL".to_string(),
                    regex: Regex::new(r#"https?://[a-zA-Z0-9\-]+\.cloud\.looker\.com[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Looker tenant URL exposed".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Tableau Server URL".to_string(),
                    regex: Regex::new(r#"https?://tableau\.[a-zA-Z0-9\-]+\.[a-zA-Z]+[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Self-hosted Tableau URL exposed".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Hubspot Portal ID".to_string(),
                    regex: Regex::new(r#"https?://[a-zA-Z0-9\-]+\.hubspot\.com/(?:contacts|sequences|workflows)/[0-9]+[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Low,
                    description: "Hubspot tenant URL with portal/object ID — reveals internal CRM identifiers".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Notion Internal Page".to_string(),
                    regex: Regex::new(r#"https?://(?:www\.)?notion\.so/[a-zA-Z0-9\-]{1,50}/[a-zA-Z0-9\-]+-[a-f0-9]{32}[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Internal Notion page URL exposed — page may be publicly accessible".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Linear Issue URL".to_string(),
                    regex: Regex::new(r#"https?://linear\.app/[a-zA-Z0-9\-]+/issue/[A-Z]{2,8}-\d+[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Low,
                    description: "Linear issue URL exposed — reveals internal project tracker".to_string(),
                    cwe: "CWE-200".to_string(),
                },
            ],
