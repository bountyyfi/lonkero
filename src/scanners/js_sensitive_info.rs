        ...
        SensitivePatterns {
            ...
            internal_tools: vec![
                ...
                CompiledPattern {
                    ...
                    regex: Regex::new(r#"https?://argocd[\-.][a-zA-Z0-9\-.]+\.[a-zA-Z]{2,}[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::High,
                    description: "Internal Argo CD URL found - GitOps control plane often misconfigured for anonymous SSO".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "HashiCorp Vault URL".to_string(),
                    regex: Regex::new(r#"https?://vault[\-.][a-zA-Z0-9\-.]+\.[a-zA-Z]{2,}[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::High,
                    description: "HashiCorp Vault URL found - check for unauthenticated /v1/sys endpoints".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "HashiCorp Consul URL".to_string(),
                    regex: Regex::new(r#"https?://consul[\-.][a-zA-Z0-9\-.]+\.[a-zA-Z]{2,}[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::High,
                    description: "HashiCorp Consul URL found - service mesh control plane".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Rancher URL".to_string(),
                    regex: Regex::new(r#"https?://rancher[\-.][a-zA-Z0-9\-.]+\.[a-zA-Z]{2,}[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::High,
                    description: "Rancher URL found - Kubernetes management plane".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Portainer URL".to_string(),
                    regex: Regex::new(r#"https?://portainer[\-.][a-zA-Z0-9\-.]+\.[a-zA-Z]{2,}[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::High,
                    description: "Portainer URL found - Docker/Kubernetes admin panel".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Drone CI URL".to_string(),
                    regex: Regex::new(r#"https?://drone[\-.][a-zA-Z0-9\-.]+\.[a-zA-Z]{2,}[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Drone CI URL found".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Concourse CI URL".to_string(),
                    regex: Regex::new(r#"https?://concourse[\-.][a-zA-Z0-9\-.]+\.[a-zA-Z]{2,}[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Concourse CI URL found".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Spinnaker URL".to_string(),
                    regex: Regex::new(r#"https?://spinnaker[\-.][a-zA-Z0-9\-.]+\.[a-zA-Z]{2,}[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Spinnaker deployment URL found".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Backstage URL".to_string(),
                    regex: Regex::new(r#"https?://backstage[\-.][a-zA-Z0-9\-.]+\.[a-zA-Z]{2,}[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Backstage developer portal URL found - check for plugin auth misconfig".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Sentry Self-Hosted URL".to_string(),
                    regex: Regex::new(r#"https?://sentry[\-.][a-zA-Z0-9\-.]+\.[a-zA-Z]{2,}[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Self-hosted Sentry URL found".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Mattermost URL".to_string(),
                    regex: Regex::new(r#"https?://mattermost[\-.][a-zA-Z0-9\-.]+\.[a-zA-Z]{2,}[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Mattermost URL found - internal chat platform".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Metabase URL".to_string(),
                    regex: Regex::new(r#"https?://metabase[\-.][a-zA-Z0-9\-.]+\.[a-zA-Z]{2,}[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::High,
                    description: "Metabase BI URL found - frequently expose query results without auth".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Apache Superset URL".to_string(),
                    regex: Regex::new(r#"https?://superset[\-.][a-zA-Z0-9\-.]+\.[a-zA-Z]{2,}[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::High,
                    description: "Apache Superset URL found - BI tool with frequent IDOR/RCE history".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Apache Airflow URL".to_string(),
                    regex: Regex::new(r#"https?://airflow[\-.][a-zA-Z0-9\-.]+\.[a-zA-Z]{2,}[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::High,
                    description: "Apache Airflow URL found - workflow orchestration plane (multiple RCE CVEs)".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Snowflake Account URL".to_string(),
                    regex: Regex::new(r#"https://[a-zA-Z0-9_-]+\.(?:[a-z0-9-]+\.)?snowflakecomputing\.com[^\s\"'<>]*"#).unwrap(),
                    severity: Severity::High,
                    description: "Snowflake account URL found - data warehouse endpoint".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    ...
                    severity: Severity::High,
                    description: "Databricks workspace URL found".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "AWS Step Functions Console URL".to_string(),
                    regex: Regex::new(r#"https://[a-z0-9-]+\.console\.aws\.amazon\.com/states/home\?region=[a-z0-9-]+#/statemachines/view/[^\s\"'<>]+"#).unwrap(),
                    severity: Severity::Medium,
                    description: "AWS Step Functions console link found - reveals state-machine ARN".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "BigQuery Project Console URL".to_string(),
                    regex: Regex::new(r#"https://console\.cloud\.google\.com/bigquery\?[^\s\"'<>]*project=[^\s\"'<>&]+"#).unwrap(),
                    severity: Severity::Medium,
                    description: "BigQuery console URL found - reveals internal GCP project ID".to_string(),
                    cwe: "CWE-200".to_string(),
                },
            ],
            document_patterns: vec![
                ...
                CompiledPattern {
                    name: "Notion Public Page".to_string(),
                    regex: Regex::new(r#"https://[a-zA-Z0-9_-]+\.notion\.site/[^\s\"'<>]+"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Notion public-page URL found - often used to share internal docs world-readable".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Notion Workspace Page".to_string(),
                    regex: Regex::new(r#"https://www\.notion\.so/[a-zA-Z0-9_-]+/[^\s\"'<>]+-[a-f0-9]{32}"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Notion workspace page URL found".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Coda Doc".to_string(),
                    regex: Regex::new(r#"https://coda\.io/d/[^\s\"'<>]+"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Coda doc URL found".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Loom Video Share".to_string(),
                    regex: Regex::new(r#"https://(?:www\.)?loom\.com/share/[a-f0-9]{32}"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Loom video share URL found - often unlisted internal recordings".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Figma File Link".to_string(),
                    regex: Regex::new(r#"https://www\.figma\.com/(?:file|design|proto)/[a-zA-Z0-9]+/[^\s\"'<>]+"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Figma file/design URL found - may expose internal design/prototype".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Miro Board".to_string(),
                    regex: Regex::new(r#"https://miro\.com/app/board/[^\s\"'<>]+"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Miro board URL found".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Dropbox Paper Doc".to_string(),
                    regex: Regex::new(r#"https://paper\.dropbox\.com/doc/[^\s\"'<>]+"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Dropbox Paper doc URL found".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Box Shared File".to_string(),
                    regex: Regex::new(r#"https://[a-zA-Z0-9_-]+\.box\.com/s/[a-z0-9]{20,}"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Box shared-file URL found".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Trello Board Share".to_string(),
                    regex: Regex::new(r#"https://trello\.com/b/[A-Za-z0-9]{8}/[^\s\"'<>]+"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Trello board share URL found - often public-shared internal planning".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "AWS S3 Pre-Signed URL".to_string(),
                    regex: Regex::new(r#"https://[a-zA-Z0-9\-\.]+\.s3[\.\-][a-z0-9\-]+\.amazonaws\.com/[^\s\"'<>]+\?[^\s\"'<>]*X-Amz-Signature=[a-f0-9]{16,}"#).unwrap(),
                    severity: Severity::High,
                    description: "AWS S3 pre-signed URL found - time-limited but downloadable now".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Google Cloud Storage Signed URL".to_string(),
                    regex: Regex::new(r#"https://storage\.googleapis\.com/[^\s\"'<>]+\?[^\s\"'<>]*X-Goog-Signature=[a-f0-9]{16,}"#).unwrap(),
                    severity: Severity::High,
                    description: "Google Cloud Storage signed URL found".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "OneDrive/SharePoint Share Link".to_string(),
                    regex: Regex::new(r#"https://[a-zA-Z0-9_-]+\-?my\.sharepoint\.com/[^\s\"'<>]+"#).unwrap(),
                    severity: Severity::Medium,
                    description: "OneDrive personal share URL found - often expose internal documents".to_string(),
                    cwe: "CWE-200".to_string(),
                },
            ],
            admin_debug_patterns: vec![
                ...
                CompiledPattern {
                    name: "Impersonation Endpoint".to_string(),
                    regex: Regex::new(r#"[\"'](?:/(?:api/)?(?:admin/)?(?:users?/)?(?:impersonate|sudo|act_as|become|loginAs|switchUser)(?:/[^\"']*)?)[\"']"#).unwrap(),
                    severity: Severity::Critical,
                    description: "Account impersonation endpoint referenced - if reachable without admin authz, allows account takeover".to_string(),
                    cwe: "CWE-269".to_string(),
                },
                CompiledPattern {
                    name: "Mock/Demo Login Endpoint".to_string(),
                    regex: Regex::new(r#"[\"'](?:/(?:api/)?(?:auth/)?(?:mock|demo|fake|stub)[_-]?(?:login|auth|user|session))[\"']"#).unwrap(),
                    severity: Severity::Critical,
                    description: "Mock/demo authentication endpoint - frequently leaked to production".to_string(),
                    cwe: "CWE-489".to_string(),
                },
                CompiledPattern {
                    name: "Backdoor Token Param".to_string(),
                    regex: Regex::new(r#"(?i)(?:backdoor|magic[_-]?token|master[_-]?key|skeleton[_-]?key|godmode)\s*[=:]"#).unwrap(),
                    severity: Severity::Critical,
                    description: "Backdoor/master-token reference - check whether the bypass code path ships to production".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    name: "Spring Boot Actuator Endpoint".to_string(),
                    regex: Regex::new(r#"[\"'](?:/actuator/(?:env|heapdump|threaddump|configprops|mappings|loggers|gateway|beans|jolokia|prometheus|metrics|health))[\"']"#).unwrap(),
                    severity: Severity::High,
                    description: "Spring Boot Actuator sensitive endpoint referenced - test for unauthenticated access".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "GraphQL Admin/Debug Endpoint".to_string(),
                    regex: Regex::new(r#"[\"'](?:/(?:graphql|api/graphql)/(?:admin|debug|internal|playground|introspect|console)|/(?:admin|internal)[_-]?graphql)[\"']"#).unwrap(),
                    severity: Severity::High,
                    description: "GraphQL admin/debug endpoint referenced - common authorization-bypass surface".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Internal Health Or Metrics Endpoint".to_string(),
                    regex: Regex::new(r#"[\"'](?:/_metrics|/_admin|/_health|/_status|/_internal|/healthz/internal|/metrics/private)[\"']"#).unwrap(),
                    severity: Severity::Medium,
                    description: "Internal health/metrics endpoint referenced".to_string(),
                    cwe: "CWE-200".to_string(),
                },
                CompiledPattern {
                    name: "Insecure Direct Object Reference Pattern".to_string(),
                    regex: Regex::new(r#"[\"'](?:/(?:api/)?(?:v\d+/)?(?:users?|accounts?|tenants?|orgs?|customers?)/\$?\{[a-zA-Z]*[Ii]d\})[\"']"#).unwrap(),
                    severity: Severity::Low,
                    description: "Endpoint template suggesting direct numeric IDs - audit for IDOR".to_string(),
            ...
            credential_patterns: vec![
                ...
                // AWS STS temporary credentials (ASIA prefix) - active session keys
                CompiledPattern {
                    name: "AWS Temporary Access Key (STS)".to_string(),
                    regex: Regex::new(r#"ASIA[0-9A-Z]{16}"#).unwrap(),
                    severity: Severity::Critical,
                    description: "AWS STS temporary access key found - indicates an active assumed-role session leaked client-side".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                // Slack bot/user/app/workflow tokens have well-defined deterministic prefixes
                CompiledPattern {
                    name: "Slack Bot Token".to_string(),
                    regex: Regex::new(r#"xoxb-\d{10,13}-\d{10,13}-[A-Za-z0-9]{24,34}"#).unwrap(),
                    severity: Severity::Critical,
                    description: "Slack bot user OAuth token found - allows acting as the bot".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    ...
                    severity: Severity::Critical,
                    description: "Slack user OAuth token found - full user-scoped workspace access".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    ...
                    severity: Severity::Critical,
                    description: "Slack app-level (Socket Mode) token found".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    name: "Slack Workflow Token".to_string(),
                    regex: Regex::new(r#"xoxw-\d{10,13}-\d{10,13}"#).unwrap(),
                    severity: Severity::High,
                    description: "Slack workflow token found".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    name: "Slack Refresh Token".to_string(),
                    regex: Regex::new(r#"xoxe(?:\.xox[bp])?-\d-[A-Z0-9-]{146,}"#).unwrap(),
                    severity: Severity::Critical,
                    description: "Slack refresh token found".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                // Stripe restricted keys and webhook signing secret
                CompiledPattern {
                    name: "Stripe Restricted Key".to_string(),
                    regex: Regex::new(r#"rk_(?:live|test)_[A-Za-z0-9]{24,}"#).unwrap(),
                    severity: Severity::Critical,
                    description: "Stripe restricted key found - scoped API access still allows abuse on permitted resources".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    ...
                    severity: Severity::Critical,
                    description: "Stripe webhook signing secret found - allows forging webhook events".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                // PostHog API keys (project keys are intentionally public; personal keys are not)
                CompiledPattern {
                    name: "PostHog Personal API Key".to_string(),
                    regex: Regex::new(r#"\bphx_[A-Za-z0-9]{43}\b"#).unwrap(),
                    severity: Severity::Critical,
                    description: "PostHog personal API key found - full account access".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                ...
                CompiledPattern {
                    ...
                    severity: Severity::Critical,
                    description: "Hugging Face access token found - private model and dataset access".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                // Replicate API token (deterministic r8_ prefix)
                CompiledPattern {
                    name: "Replicate API Token".to_string(),
                    regex: Regex::new(r#"\br8_[A-Za-z0-9]{37,40}\b"#).unwrap(),
                    severity: Severity::Critical,
                    description: "Replicate API token found - allows model inference at the account's expense".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                // OpenRouter (sk-or-v1-)
                CompiledPattern {
                    ...
                    severity: Severity::Critical,
                    description: "OpenRouter API key found - LLM proxy billable to the owner".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                // Render
                CompiledPattern {
                    ...
                    severity: Severity::Critical,
                    description: "Render API key found - allows deploy / env-var read on the account".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                // Tailscale auth keys (deterministic prefixes)
                CompiledPattern {
                    name: "Tailscale Auth Key".to_string(),
                    regex: Regex::new(r#"tskey-auth-[A-Za-z0-9-]{10,}-[A-Za-z0-9]{20,}"#).unwrap(),
                    severity: Severity::Critical,
                    description: "Tailscale tailnet auth key found - allows joining the private mesh".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    ...
                    severity: Severity::Critical,
                    description: "Tailscale OAuth client secret found".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    name: "Tailscale API Access Token".to_string(),
                    regex: Regex::new(r#"tskey-api-[A-Za-z0-9-]{10,}-[A-Za-z0-9]{20,}"#).unwrap(),
                    severity: Severity::Critical,
                    description: "Tailscale API access token found - control-plane access".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                ...
                // GCP service-account JSON: full key + client_email pair
                CompiledPattern {
                    name: "GCP Service Account JSON".to_string(),
                    regex: Regex::new(r#"\"type\":\s*\"service_account\""#).unwrap(),
                    severity: Severity::Critical,
                    description: "GCP service-account JSON found - typically pairs with an embedded private_key for full project access".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                // Linode / Akamai Cloud personal access tokens require explicit context
                CompiledPattern {
                    name: "Linode Personal Access Token".to_string(),
                    regex: Regex::new(r#"(?i)linode[_-]?(?:api[_-]?)?(?:token|key)\s*[=:]\s*['\"][a-f0-9]{64}['\"]"#).unwrap(),
                    severity: Severity::Critical,
                    description: "Linode (Akamai Cloud) personal access token found".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                // Vultr API key
                CompiledPattern {
                    ...
                    severity: Severity::Critical,
                    description: "Vultr API key found".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                // Sumo Logic access pair (high-impact: log search + ingest)
                CompiledPattern {
                    name: "Sumo Logic Access Key".to_string(),
                    regex: Regex::new(r#"(?i)sumo[_-]?(?:logic[_-]?)?(?:access[_-]?)?key\s*[=:]\s*['\"][A-Za-z0-9]{64}['\"]"#).unwrap(),
                    severity: Severity::Critical,
                    description: "Sumo Logic access key found - log infrastructure access".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                // PayPal/Braintree sandbox token (mirrors the production pattern above)
                CompiledPattern {
                    name: "PayPal/Braintree Sandbox Token".to_string(),
                    regex: Regex::new(r#"access_token\$sandbox\$[a-z0-9]{16}\$[a-f0-9]{32}"#).unwrap(),
                    severity: Severity::High,
                    description: "PayPal/Braintree sandbox access token found".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                // GitHub Server-to-Server installation token (ghs_) - separate so it's labelled
                CompiledPattern {
                    name: "GitHub App Installation Token".to_string(),
                    regex: Regex::new(r#"ghs_[A-Za-z0-9_]{36,}"#).unwrap(),
                    severity: Severity::Critical,
                    description: "GitHub App installation access token found - acts as the installed app".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                // Cloudflare Pages / Workers preview deployment URL (often references internal env-vars/build secrets)
                // Adobe IO integration JWT
                CompiledPattern {
                    name: "Adobe IO Client Secret".to_string(),
                    regex: Regex::new(r#"(?i)adobe[_-]?(?:io[_-]?)?client[_-]?secret\s*[=:]\s*['\"]p8e-[A-Za-z0-9_-]{32,}['\"]"#).unwrap(),
                    severity: Severity::Critical,
                    description: "Adobe IO client secret found".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                // Razorpay key pair (live keys = production money flow)
                CompiledPattern {
                    name: "Razorpay Live Key ID".to_string(),
                    regex: Regex::new(r#"rzp_live_[A-Za-z0-9]{14}"#).unwrap(),
                    severity: Severity::High,
                    description: "Razorpay live key ID found - paired with a secret it can charge real cards".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                CompiledPattern {
                    name: "Razorpay Test Key ID".to_string(),
                    regex: Regex::new(r#"rzp_test_[A-Za-z0-9]{14}"#).unwrap(),
                    severity: Severity::Low,
                    description: "Razorpay test key ID found".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                // Atlassian: bot/connect JWT signature for forge apps
                CompiledPattern {
                    name: "Atlassian Connect Shared Secret".to_string(),
                    regex: Regex::new(r#"(?i)atlassian[_-]?(?:connect[_-]?)?(?:shared[_-]?)?secret\s*[=:]\s*['\"][A-Za-z0-9_-]{40,}['\"]"#).unwrap(),
                    severity: Severity::Critical,
                    description: "Atlassian Connect shared secret found - allows minting Jira/Confluence app tokens".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                // Pinecone (vector DB) - context-required UUID
                CompiledPattern {
                    name: "Pinecone API Key".to_string(),
                    regex: Regex::new(r#"(?i)pinecone[_-]?(?:api[_-]?)?key\s*[=:]\s*['\"][a-f0-9]{8}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{4}-[a-f0-9]{12}['\"]"#).unwrap(),
                    severity: Severity::High,
                    description: "Pinecone vector-database API key found".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                // Mailgun webhook signing key
                CompiledPattern {
                    name: "Mailgun Webhook Signing Key".to_string(),
                    regex: Regex::new(r#"(?i)mailgun[_-]?(?:webhook[_-]?)?(?:signing[_-]?)?key\s*[=:]\s*['\"][a-f0-9]{32}-[a-f0-9]{8}-[a-f0-9]{8}['\"]"#).unwrap(),
                    severity: Severity::High,
                    description: "Mailgun webhook signing key found - allows forging webhook events".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                // Klaviyo private API key (pk_ pattern is Stripe-shaped; require context)
                CompiledPattern {
                    name: "Klaviyo Private API Key".to_string(),
                    regex: Regex::new(r#"(?i)klaviyo[_-]?(?:private[_-]?)?(?:api[_-]?)?key\s*[=:]\s*['\"]pk_[a-f0-9]{34}['\"]"#).unwrap(),
                    severity: Severity::Critical,
                    description: "Klaviyo private API key found".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                // Telnyx API key (KEY prefix + Base64 padded length)
                CompiledPattern {
                    name: "Telnyx API Key".to_string(),
                    regex: Regex::new(r#"(?i)telnyx[_-]?(?:api[_-]?)?key\s*[=:]\s*['\"]KEY[A-Z0-9]{32}_[A-Za-z0-9]{20,}['\"]"#).unwrap(),
                    severity: Severity::Critical,
                    description: "Telnyx API key found - allows SMS / voice access".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                // Crowdstrike Falcon API client pair
                CompiledPattern {
                    name: "CrowdStrike Falcon Client Secret".to_string(),
                    regex: Regex::new(r#"(?i)(?:falcon|crowdstrike)[_-]?(?:client[_-]?)?secret\s*[=:]\s*['\"][A-Za-z0-9]{40}['\"]"#).unwrap(),
                    severity: Severity::Critical,
                    description: "CrowdStrike Falcon API client secret found - EDR control-plane access".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                // Snowflake username:password URL or PAT
                CompiledPattern {
                    name: "Snowflake Programmatic Access Token".to_string(),
                    regex: Regex::new(r#"(?i)snowflake[_-]?(?:pat|token)\s*[=:]\s*['\"][A-Za-z0-9]{40,}['\"]"#).unwrap(),
                    severity: Severity::Critical,
                    description: "Snowflake programmatic access token found - data warehouse access".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                ...
                CompiledPattern {
                    ...
                    severity: Severity::Critical,
                    description: "Databricks personal access token found - notebook and cluster access".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                ...
                CompiledPattern {
                    ...
                    severity: Severity::Critical,
                    description: "Grafana service-account token found".to_string(),
                    cwe: "CWE-798".to_string(),
                },
                // Heroku platform OAuth token (HRKU- prefix)
                CompiledPattern {
                    name: "Heroku OAuth Token (HRKU-)".to_string(),
                    regex: Regex::new(r#"HRKU-[A-Za-z0-9_-]{43}"#).unwrap(),
                    severity: Severity::Critical,
                    description: "Heroku OAuth bearer token found".to_string(),
                    cwe: "CWE-798".to_string(),
                },
            ],
