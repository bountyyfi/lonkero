...
///
/// Includes the canonical paths plus the deterministic outputs of popular
/// frameworks: Springdoc / springfox (`/v3/api-docs`, `/v2/api-docs`),
/// Quarkus (`/q/openapi`), FastAPI (`/openapi.json`), Nest.js Swagger,
/// Django Rest Framework's `drf-spectacular` (`/schema/`), Stoplight Elements,
/// ASP.NET Core's NSwag (`/swagger/v1/swagger.json`), Hapi (`/swaggerui/swagger.json`),
/// Loopback (`/explorer/swagger.json`), and the `/.well-known/` API discovery path.
const OPENAPI_PATHS: &[&str] = &[
    // Canonical filenames at the site root
    "/swagger.json",
    "/swagger.yaml",
    "/swagger.yml",
    "/openapi.json",
    ...
    "/api/v3/swagger.json",
    "/api/v3/openapi.json",
    // ASP.NET Core (Swashbuckle/NSwag) default versions
    ...
    // Service mesh / sidecar APIs
    "/openapi/v3/api-docs",
    "/openapi/v2/api-docs",
    "/.well-known/openapi.json",
    "/.well-known/oas.json",
    "/.well-known/api-catalog",
    // Postman collection (often co-deployed)
    "/postman.json",
