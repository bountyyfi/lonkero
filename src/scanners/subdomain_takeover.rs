...
const SERVICE_FINGERPRINTS: &[ServiceFingerprint] = &[
    ...
    // ==========================================================
    // Extended fingerprints — well-documented services with
    // distinct not-provisioned response strings. Every signature
    // below is unique enough that a match on the target's HTML
    // body is unambiguous (the strings do not appear in normal
    // application content); this keeps the scanner false-positive
    // free while widening real coverage.
    // ==========================================================
    // Kajabi
    ServiceFingerprint {
        name: "Kajabi",
        cname_patterns: &[".mykajabi.com"],
        http_signatures: &["The page you were looking for doesn't exist."],
        header_patterns: &[],
        nxdomain_vulnerable: false,
        severity: Severity::High,
        cvss: 8.0,
    ...
    ServiceFingerprint {
        ...
        http_signatures: &["You are being <a href=\"https://www.statuspage.io"],
        header_patterns: &[],
        nxdomain_vulnerable: false,
        severity: Severity::Medium,
        cvss: 7.5,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or claim the Statuspage under your account.",
    },
    // ReadMe.io
    ServiceFingerprint {
        name: "ReadMe.io",
        cname_patterns: &[".readme.io", ".readmessl.com"],
        http_signatures: &["Project doesnt exist... yet!"],
        header_patterns: &[],
        nxdomain_vulnerable: false,
        severity: Severity::High,
        cvss: 8.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or create a ReadMe project for the domain.",
    },
    // WebFlow
    ServiceFingerprint {
        name: "WebFlow",
        cname_patterns: &[".proxy.webflow.com", ".proxy-ssl.webflow.com", ".webflow.io"],
        http_signatures: &["The page you are looking for doesn't exist or has been moved."],
        header_patterns: &[],
        nxdomain_vulnerable: false,
        severity: Severity::High,
        cvss: 8.0,
    ...
    ServiceFingerprint {
        ...
        http_signatures: &["But if you're looking to build your own website"],
        header_patterns: &[],
        nxdomain_vulnerable: false,
        severity: Severity::Medium,
        cvss: 7.0,
    ...
    ServiceFingerprint {
        ...
        http_signatures: &["We couldn't find your form."],
        header_patterns: &[],
        nxdomain_vulnerable: false,
        severity: Severity::Medium,
        cvss: 6.5,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or configure the domain in Wufoo.",
    },
    // Unbounce
    ServiceFingerprint {
        name: "Unbounce",
        cname_patterns: &[".unbouncepages.com"],
        http_signatures: &["The requested URL was not found on this server."],
        header_patterns: &[],
        nxdomain_vulnerable: false,
        severity: Severity::Medium,
        cvss: 7.0,
    ...
    ServiceFingerprint {
        ...
        http_signatures: &["No Such Account"],
        header_patterns: &[],
        nxdomain_vulnerable: false,
        severity: Severity::High,
        cvss: 8.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or configure the domain in a Squarespace site.",
    },
    // GetResponse
    ServiceFingerprint {
        name: "GetResponse",
        cname_patterns: &[".gr8.com"],
        http_signatures: &["With GetResponse Landing Pages, lead generation has never been easier"],
        header_patterns: &[],
        nxdomain_vulnerable: false,
        severity: Severity::Medium,
        cvss: 6.5,
    ...
    ServiceFingerprint {
        ...
        http_signatures: &["404 Blog is not found"],
        header_patterns: &[],
        nxdomain_vulnerable: false,
        severity: Severity::Medium,
        cvss: 6.5,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or claim the blog on HatenaBlog.",
    },
    // BigCartel
    ServiceFingerprint {
        name: "BigCartel",
        cname_patterns: &[".bigcartel.com"],
        http_signatures: &["<h1>Oops! We couldn&#8217;t find that page.</h1>"],
        header_patterns: &[],
        nxdomain_vulnerable: false,
        severity: Severity::Medium,
        cvss: 6.5,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or configure the domain in BigCartel.",
    },
    // FeedPress
    ServiceFingerprint {
        name: "FeedPress",
        cname_patterns: &[".feedpress.me", "redirect.feedpress.me"],
        http_signatures: &["The feed has not been found."],
        header_patterns: &[],
        nxdomain_vulnerable: false,
        severity: Severity::Low,
        cvss: 5.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or configure the feed in FeedPress.",
    },
    // LaunchRock
    ServiceFingerprint {
        name: "LaunchRock",
        cname_patterns: &[".launchrock.com"],
        http_signatures: &["It looks like you may have taken a wrong turn somewhere"],
        header_patterns: &[],
        nxdomain_vulnerable: false,
        severity: Severity::Medium,
        cvss: 6.5,
    ...
    ServiceFingerprint {
        ...
        http_signatures: &["The URL you've accessed does not provide a hub."],
        header_patterns: &[],
        nxdomain_vulnerable: false,
        severity: Severity::Medium,
        cvss: 6.5,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or claim the hub in Uberflip.",
    },
    // Anima
    ServiceFingerprint {
        name: "Anima",
        cname_patterns: &[".animaapp.io"],
        http_signatures: &["If you're moving your domain away from Anima"],
        header_patterns: &[],
        nxdomain_vulnerable: false,
        severity: Severity::Medium,
        cvss: 6.5,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or reconfigure the domain in Anima.",
    },
    // HelpJuice
    ServiceFingerprint {
        name: "HelpJuice",
        cname_patterns: &[".helpjuice.com"],
        http_signatures: &["We could not find what you're looking for."],
        header_patterns: &[],
        nxdomain_vulnerable: false,
        severity: Severity::Medium,
        cvss: 6.5,
    ...
    ServiceFingerprint {
        ...
        cvss: 6.5,
        confirmed_exploitable: false,
        remediation: "Remove the CNAME record or claim the workspace in JetBrains Space.",
    },
    // Kinsta static hosting (Kinsta APM)
    ServiceFingerprint {
        name: "Kinsta",
        cname_patterns: &[".kinsta.cloud", ".kinsta.com", ".kinstacdn.com"],
    ...
    // Render.com (static / web services)
    ServiceFingerprint {
        name: "Render",
        cname_patterns: &[".onrender.com"],
        http_signatures: &["Not Found", "x-render-routing: no-server"],
        header_patterns: &[("x-render-routing", "no-server")],
        nxdomain_vulnerable: false,
        severity: Severity::High,
        cvss: 8.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or attach the domain to a Render service.",
    },
    // Framer sites
    ServiceFingerprint {
        name: "Framer",
        cname_patterns: &[".framer.website", ".framer.app", ".framer.wiki", ".framer.link"],
        http_signatures: &["Site Not Found. Why am I seeing this?"],
        header_patterns: &[],
        nxdomain_vulnerable: false,
        severity: Severity::High,
        cvss: 8.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or attach the domain to a Framer site.",
    },
    // Cloudimage
    ServiceFingerprint {
        name: "Cloudimage",
        cname_patterns: &[".cloudimg.io"],
        http_signatures: &["Unable to find application"],
        header_patterns: &[],
        nxdomain_vulnerable: false,
        severity: Severity::Medium,
        cvss: 6.5,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or register the token in Cloudimage.",
    },
    // Google Cloud Storage buckets referenced as CNAMEs
    ServiceFingerprint {
        name: "Google Cloud Storage",
        cname_patterns: &["c.storage.googleapis.com", ".storage.googleapis.com"],
        http_signatures: &["<Code>NoSuchBucket</Code>", "The specified bucket does not exist"],
        header_patterns: &[],
        nxdomain_vulnerable: false,
        severity: Severity::Critical,
        cvss: 9.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or recreate the GCS bucket with the same name to claim it.",
    },
    // Azure API Management gateway
    ServiceFingerprint {
        name: "Azure API Management",
        cname_patterns: &[".azure-api.net"],
        http_signatures: &["Resource Not Found"],
        header_patterns: &[],
        nxdomain_vulnerable: true,
        severity: Severity::High,
        cvss: 8.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or provision an APIM instance with this hostname.",
    },
    // Azure Front Door
    ServiceFingerprint {
        name: "Azure Front Door",
        cname_patterns: &[".azurefd.net", ".azureedge.net"],
        http_signatures: &["Our services aren't available right now"],
        header_patterns: &[],
        nxdomain_vulnerable: true,
        severity: Severity::High,
        cvss: 8.5,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or provision the corresponding Front Door / CDN profile.",
    },
    // Digital Ocean Apps (App Platform)
    ServiceFingerprint {
        name: "DigitalOcean App Platform",
        cname_patterns: &[".ondigitalocean.app"],
        http_signatures: &["Application not found"],
        header_patterns: &[],
        nxdomain_vulnerable: false,
        severity: Severity::High,
        cvss: 8.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or attach the domain to a DO App Platform application.",
    },
    ...
    ServiceFingerprint {
        ...
        cvss: 8.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or provision a Beanstalk environment with the same CNAME prefix.",
    },
    ...
    ServiceFingerprint {
        ...
        cvss: 8.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or reprovision the accelerator.",
    },
    // Intercom custom domain
    ServiceFingerprint {
        name: "Intercom",
        cname_patterns: &["custom.intercom.help"],
        http_signatures: &["This page is reserved for artistic dogs."],
        header_patterns: &[],
        nxdomain_vulnerable: false,
        severity: Severity::Medium,
        cvss: 6.5,
    ...
    ServiceFingerprint {
        ...
        http_signatures: &["Company Not Found"],
        header_patterns: &[],
        nxdomain_vulnerable: false,
        severity: Severity::Medium,
        cvss: 6.5,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or configure the domain in Canny.",
    },
    // Airee.ru (CDN)
    ServiceFingerprint {
        name: "Airee.ru",
        cname_patterns: &[".airee.ru"],
        http_signatures: &["Ошибка 402. Сервис Айри.рф не оплачен"],
        header_patterns: &[],
        nxdomain_vulnerable: false,
        severity: Severity::Medium,
        cvss: 6.5,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or renew the Airee service.",
    },
    // Worksites.net
    ServiceFingerprint {
        name: "Worksites",
        cname_patterns: &[".worksites.net"],
        http_signatures: &["Hello! Sorry, but this website is either unavailable or not found."],
        header_patterns: &[],
        nxdomain_vulnerable: false,
        severity: Severity::Medium,
        cvss: 6.5,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or reconfigure the Worksites project.",
    },
    // Teamwork subdomain takeover
    ServiceFingerprint {
        name: "Teamwork",
        cname_patterns: &[".teamwork.com"],
        http_signatures: &["Oops - We didn't find your site."],
        header_patterns: &[],
        nxdomain_vulnerable: false,
        severity: Severity::Medium,
        cvss: 6.5,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or claim the domain in Teamwork.",
    },
    // Tictail
    ServiceFingerprint {
        name: "Tictail",
        cname_patterns: &[".tictail.com", "domains.tictail.com"],
        http_signatures: &["to target URL: <a href=\"https://tictail.com"],
        header_patterns: &[],
        nxdomain_vulnerable: false,
        severity: Severity::Medium,
        cvss: 6.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or configure the domain in Tictail.",
    },
];
