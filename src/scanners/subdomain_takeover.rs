...
const SERVICE_FINGERPRINTS: &[ServiceFingerprint] = &[
    ...
    ServiceFingerprint {
        ...
        http_signatures: &[
            ...
            "There isn't a Statuspage page here",
        ],
        header_patterns: &[],
        nxdomain_vulnerable: false,
        severity: Severity::High,
        cvss: 8.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or claim the custom domain in your Statuspage.io settings.",
    },
    // Strikingly
    ServiceFingerprint {
        name: "Strikingly",
    ...
    ServiceFingerprint {
        ...
        cvss: 8.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or claim the custom domain in Thinkific.",
    },
    // Teamwork
    ServiceFingerprint {
        name: "Teamwork",
    ...
    ServiceFingerprint {
        ...
        cvss: 8.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or claim the custom domain in Wishpond.",
    },
    // Aftership
    ServiceFingerprint {
        name: "Aftership",
        ...
        http_signatures: &[
            "Oops.</h2><p class=\"p-r\">The page you're looking for doesn't exist.",
        ],
        header_patterns: &[],
        nxdomain_vulnerable: false,
        severity: Severity::High,
        cvss: 8.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or claim the domain in Aftership.",
    },
    // Aha!
    ServiceFingerprint {
        name: "Aha",
    ...
    ServiceFingerprint {
        ...
        cvss: 8.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or claim the domain in Anima.",
    },
    // Uberflip
    ServiceFingerprint {
        name: "Uberflip",
        cname_patterns: &[".hubs.vidyard.com", ".uberflip.com"],
        http_signatures: &[
        ...
        cvss: 8.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or configure the custom domain in Uberflip.",
    },
    // Unbounce
    ServiceFingerprint {
        name: "Unbounce",
    ...
    ServiceFingerprint {
        ...
        cvss: 8.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or claim the InCloud YouTrack instance in JetBrains.",
    },
    // Feedpress
    ServiceFingerprint {
        name: "Feedpress",
        ...
        cvss: 6.5,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or claim the feed in Feedpress.",
    },
    // SimpleBooklet
    ServiceFingerprint {
        name: "SimpleBooklet",
    ...
    ServiceFingerprint {
        name: "SurveyGizmo",
        cname_patterns: &[".privatedomain.sgizmo.com", ".privatedomain.surveygizmo.eu"],
        http_signatures: &[
            "data-html=true data-original-title=\"Survey does not exist\"",
        ],
        header_patterns: &[],
        nxdomain_vulnerable: false,
        severity: Severity::Medium,
        cvss: 7.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or configure the private domain in SurveyGizmo/Alchemer.",
    },
    // Tictail
    ServiceFingerprint {
        name: "Tictail",
    ...
    ServiceFingerprint {
        ...
        http_signatures: &[
            "If you need immediate help, contact GitBook support.",
            "Domain not found",
        ],
        header_patterns: &[],
        nxdomain_vulnerable: false,
    ...
    // Read the Docs (custom domain)
    ServiceFingerprint {
        name: "Read the Docs",
        cname_patterns: &[".readthedocs.io", "readthedocs.io"],
        http_signatures: &[
            "The host you requested (",
            ") does not have any project associated with it.",
            "Unknown Domain",
        ],
        header_patterns: &[],
        nxdomain_vulnerable: false,
        ...
        cvss: 6.5,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or associate the domain with a Read the Docs project.",
    },
    // Kinsta
    ServiceFingerprint {
        name: "Kinsta",
        ...
        cvss: 8.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or configure the domain in Kinsta.",
    },
    // Worksites.net
    ServiceFingerprint {
        name: "Worksites.net",
        ...
        cvss: 6.5,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or claim the domain in Worksites.net.",
    },
    // Getresponse
    ServiceFingerprint {
        name: "GetResponse",
        ...
        cvss: 6.5,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or claim the custom domain in GetResponse.",
    },
    // ngrok (dev-tunnels frequently left in production)
    ServiceFingerprint {
        name: "ngrok",
        ...
        cvss: 8.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or reserve the ngrok subdomain (never expose dev tunnels in production).",
    },
    // Canny.io
    ServiceFingerprint {
        name: "Canny",
        ...
        cvss: 6.5,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or claim the domain in Canny.",
    },
    // Frontify
    ServiceFingerprint {
        name: "Frontify",
        ...
        http_signatures: &[
            "This Frontify workspace is currently unavailable.",
        ],
        header_patterns: &[],
        nxdomain_vulnerable: false,
        severity: Severity::Medium,
        cvss: 6.5,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or configure the workspace in Frontify.",
    },
    // Discourse (hosting)
    ServiceFingerprint {
        name: "Discourse",
        cname_patterns: &[".discourse.group"],
        http_signatures: &[
            "This Discourse discussion is unavailable",
        ],
        header_patterns: &[],
        nxdomain_vulnerable: false,
        severity: Severity::Medium,
        cvss: 6.5,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or configure the domain in Discourse hosting.",
    },
    // HubSpot (custom domain)
    ServiceFingerprint {
        name: "HubSpot",
        cname_patterns: &[".hs-sites.com", ".hubspotusercontent"],
        http_signatures: &[
            "Domain not found. Please make sure the domain settings are correct.",
        ],
        header_patterns: &[],
        nxdomain_vulnerable: false,
        severity: Severity::High,
        cvss: 7.5,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or configure the domain in HubSpot CMS.",
    },
    // Instapage
    ServiceFingerprint {
        name: "Instapage",
        cname_patterns: &[".pageserve.co", ".secure.pageserve.co", ".instapage.com"],
        http_signatures: &[
        ...
        cvss: 6.5,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or claim the domain in Instapage.",
    },
];
...
impl SubdomainTakeoverScanner {
    ...
    async fn enumerate_subdomains(&self, domain: &str, thorough: bool) -> Vec<String> {
        ...
        let extended_prefixes = vec![
            ...
            "logging",
            "logs",
            // High-signal sensitive-surface prefixes commonly found dangling
            "kibana",
            "grafana",
            "prometheus",
            "elasticsearch",
