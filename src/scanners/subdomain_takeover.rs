...
const SERVICE_FINGERPRINTS: &[ServiceFingerprint] = &[
    ...
    // Read the Docs — hosted documentation. Signature is verbatim from RTD's
    // project-not-found page and never appears on a legitimately configured docs site.
    ServiceFingerprint {
        name: "Read the Docs",
        ...
        cvss: 8.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or reclaim the Read the Docs project.",
    },
    // HubSpot Landing Pages / CMS. Signature only appears on unclaimed custom domains.
    ServiceFingerprint {
        name: "HubSpot",
        cname_patterns: &[".hubspotpagebuilder.com", ".hs-sites.com", ".hubspot.com"],
        http_signatures: &[
        ...
        cvss: 8.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or connect the domain in HubSpot's domain manager.",
    },
    // Kajabi — online course platform. Fingerprint text is a fixed page copy.
    ServiceFingerprint {
        name: "Kajabi",
        cname_patterns: &[".kajabi.com", ".mykajabi.com"],
        http_signatures: &[
        ...
        cvss: 8.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or claim the domain in Kajabi settings.",
    },
    // LaunchRock — landing page service (defunct, still reachable via legacy DNS).
    ServiceFingerprint {
        name: "LaunchRock",
        ...
        cvss: 8.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record; LaunchRock is legacy and should not be re-pointed.",
    },
    // Strikingly — website builder. All-caps signature is very specific.
    ServiceFingerprint {
        name: "Strikingly",
    ...
    // Teamwork — project management, uses hosted subdomain.
    ServiceFingerprint {
        name: "Teamwork",
    ...
    ServiceFingerprint {
        ...
        cvss: 8.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or claim the domain in Unbounce.",
    },
    ...
    ServiceFingerprint {
        ...
        cvss: 8.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or claim the custom domain in Intercom.",
    },
    // Wistia — video hosting.
    ServiceFingerprint {
        name: "Wistia",
        cname_patterns: &[".wistia.com", "wistia.io"],
        http_signatures: &[
            "We couldn't find that Wistia Media",
        ...
        cvss: 7.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or claim the account in Wistia.",
    },
    ...
    ServiceFingerprint {
        ...
        cvss: 8.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or claim the site in Anima.",
    },
    // Big Cartel — hosted stores.
    ServiceFingerprint {
        name: "Big Cartel",
        ...
        cvss: 8.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or reclaim the domain in Big Cartel.",
    },
    // AfterShip — shipment tracking pages.
    ServiceFingerprint {
        name: "AfterShip",
        ...
        cvss: 7.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or configure the store domain in AfterShip.",
    },
    // Campaign Monitor — email marketing landing pages.
    ServiceFingerprint {
        ...
        cvss: 7.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or reclaim the domain in Campaign Monitor.",
    },
    // Hatena Blog — Japanese blog platform, common in APAC targets.
    ServiceFingerprint {
        name: "Hatena Blog",
        ...
        cvss: 7.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or configure the blog in Hatena.",
    },
    // Simplebooklet — flipbook publishing.
    ServiceFingerprint {
        name: "Simplebooklet",
        cname_patterns: &[".simplebooklet.com"],
        http_signatures: &[
            "We can't find this <b>Simple</b>booklet",
        ],
        header_patterns: &[],
        nxdomain_vulnerable: false,
        severity: Severity::Medium,
        cvss: 6.5,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or claim the domain in Simplebooklet.",
    },
    ...
    ServiceFingerprint {
        ...
        http_signatures: &[
            "The URL you've come to is not in service at this time",
        ],
        header_patterns: &[],
        nxdomain_vulnerable: false,
        severity: Severity::Medium,
        cvss: 7.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or reclaim the hub in Uberflip.",
    },
    ...
    ServiceFingerprint {
        ...
        cvss: 8.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or claim the domain in a Webflow project.",
    },
    // Announcekit — changelog hosting.
    ServiceFingerprint {
        name: "AnnounceKit",
        ...
        cvss: 6.5,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or reclaim the widget in AnnounceKit.",
    },
    ...
    ServiceFingerprint {
        ...
        cvss: 7.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or reclaim the domain in GetResponse.",
    },
    ...
    ServiceFingerprint {
        ...
        cvss: 8.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or reclaim the school in Thinkific.",
    },
    // AWS Elastic Beanstalk — NXDOMAIN when environment is terminated.
    ServiceFingerprint {
    ...
    // Google Cloud Storage — the `NoSuchBucket` XML response is authoritative.
    ServiceFingerprint {
    ...
    // Firebase Hosting — NXDOMAIN when project is deleted; site URLs stay pointed.
    ServiceFingerprint {
        ...
        cvss: 8.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or recreate the Firebase project/site with the matching name.",
    },
    // Squarespace — signature only appears on unclaimed custom domains.
    ServiceFingerprint {
        name: "Squarespace",
        ...
        cvss: 8.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or reclaim the domain in Squarespace domain settings.",
    },
    // Smugmug — photo hosting with vanity domains.
    ServiceFingerprint {
        name: "SmugMug",
        ...
        cvss: 6.5,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or reclaim the vanity domain in SmugMug.",
    },
    // Worksites.net / Intuit-hosted marketing sites.
    ServiceFingerprint {
        name: "Worksites.net",
        ...
        cvss: 6.5,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME record or reclaim the account.",
    },
];
...
impl SubdomainTakeoverScanner {
    ...
    async fn enumerate_subdomains(&self, domain: &str, thorough: bool) -> Vec<String> {
        ...
        //
        // Prioritises prefixes that tend to sit in front of high-value / sensitive
        // infrastructure: secret managers, artifact registries, admin UIs, backups,
        // and identity providers. Every prefix is a plain hostname label so it will
        // resolve independently of the target's tech stack.
        let extended_prefixes = vec![
            ...
            "logging",
            "logs",
            // Identity / SSO — takeover here means auth compromise, not just a subdomain.
            "sso",
            "saml",
            "oidc",
            "idp",
            ...
            "onelogin",
            "duo",
            // Secret / key material — high impact if any of these are dangling.
            "vault",
            "hcvault",
            "kms",
            "hsm",
            ...
            "cert",
            "certificates",
            // Artifact / package registries — supply-chain exposure surface.
            "artifactory",
            "artifacts",
            "nexus",
            "harbor",
            ...
            "teamcity",
            "octopus",
            // Container orchestration / infra dashboards
            "kubernetes",
            "k8s",
            "rancher",
            "portainer",
            ...
            "looker",
            "quicksight",
            // Backups / archives — often forgotten and unmonitored.
            "backup",
            "backups",
            "snapshot",
            "snapshots",
            ...
            "dr",
            "disaster-recovery",
            // Remote access — sensitive if resolvable externally.
            "vpn2",
            "vpn3",
            "wireguard",
            "wg",
            ...
            "mgmt",
            "management",
            // Docs & knowledge (often leak internal architecture).
            "wiki",
            "internal-docs",
            "handbook",
            "runbook",
            ...
            "servicedesk",
            "servicenow",
            // Common vendor sub-brands that leak credentials or PII.
            "sap",
            "salesforce",
            "workday",
            "netsuite",
            ...
            "gusto",
            "bamboo",
            // Frequently-abandoned marketing / experiment surfaces.
            "campaign",
            "campaigns",
            "landing",
            "promo",
