...
const SERVICE_FINGERPRINTS: &[ServiceFingerprint] = &[
    ...
    // Webflow — claim by attaching the dangling custom domain to a free Webflow site.
    ServiceFingerprint {
        name: "Webflow",
        ...
        cvss: 8.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME pointing to Webflow, or add the custom domain to the Webflow project that should own it.",
    },
    // Strikingly
    ServiceFingerprint {
        name: "Strikingly",
        ...
        cvss: 8.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME or claim the matching domain inside a Strikingly site.",
    },
    // Unbounce — landing-page builder, takeoverable by configuring a free page with the dangling domain.
    ServiceFingerprint {
        name: "Unbounce",
        cname_patterns: &["unbouncepages.com", ".unbouncepages.com"],
        http_signatures: &[
        ...
        cvss: 8.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME or add the dangling domain to an Unbounce landing page.",
    },
    // Smartling
    ServiceFingerprint {
        name: "Smartling",
        ...
        cvss: 7.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME or configure the domain in Smartling.",
    },
    // Acquia
    ServiceFingerprint {
        name: "Acquia",
        cname_patterns: &[".acquia-sites.com", ".acsitefactory.com"],
        http_signatures: &[
        ...
        cvss: 8.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME or claim the Acquia site that should own this hostname.",
    },
    // Statuspage (Atlassian) — public status pages, takeoverable via custom-domain attach.
    ServiceFingerprint {
        name: "Statuspage",
        ...
        cvss: 8.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME or attach the custom domain to your Statuspage page.",
    },
    // Intercom (custom messenger / help center domain)
    ServiceFingerprint {
        name: "Intercom",
        ...
        cvss: 8.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME or configure the custom Intercom help-center domain.",
    },
    // LaunchRock
    ServiceFingerprint {
        name: "LaunchRock",
        ...
        cvss: 7.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME or claim the LaunchRock site.",
    },
    // Readme.io — API documentation hosting.
    ServiceFingerprint {
        name: "Readme.io",
        ...
        cvss: 8.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME or claim the matching Readme.io project; attackers can publish fake API docs with phishing-grade credibility.",
    },
    // Tictail
    ServiceFingerprint {
        name: "Tictail",
        ...
        cvss: 7.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME pointing to Tictail.",
    },
    // Wishpond
    ServiceFingerprint {
        name: "Wishpond",
        cname_patterns: &[".wishpond.com"],
        http_signatures: &["https://www.wishpond.com/404?campaign=true"],
        header_patterns: &[],
        nxdomain_vulnerable: false,
        severity: Severity::Medium,
        cvss: 7.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME or attach the domain to a Wishpond campaign.",
    },
    // SmartJobBoard
    ServiceFingerprint {
        name: "SmartJobBoard",
        cname_patterns: &["mysmartjobboard.com", ".mysmartjobboard.com"],
        http_signatures: &["This job board website is either expired or its domain name is invalid"],
        header_patterns: &[],
        nxdomain_vulnerable: false,
        severity: Severity::Medium,
        cvss: 7.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME or claim the SmartJobBoard site.",
    },
    // Brightcove
    ServiceFingerprint {
        name: "Brightcove",
        cname_patterns: &["brightcovegallery.com", "gallery.brightcove.com", "bcvp0rtal.com"],
        http_signatures: &["<p class=\"bc-gallery-error-code\">Error Code: 404</p>"],
        header_patterns: &[],
        nxdomain_vulnerable: false,
        severity: Severity::Medium,
        cvss: 7.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME or attach the domain to a Brightcove gallery.",
    },
    // Campaign Monitor
    ServiceFingerprint {
        ...
        cvss: 7.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME or attach the domain to a Campaign Monitor list.",
    },
    // Worksites.net (Hubspot Sites legacy)
    ServiceFingerprint {
        name: "Hubspot Sites",
        cname_patterns: &[".hs-sites.com", ".sites.hubspot.com"],
        http_signatures: &[
            "Domain not found",
        ...
        cvss: 8.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME or attach the custom domain to a HubSpot CMS page.",
    },
    // Tave — wedding/photographer CRM with custom domains.
    ServiceFingerprint {
        name: "Tave",
        cname_patterns: &["tave.com", ".tave.com"],
        http_signatures: &["<h1>Error 404: Page Not Found</h1>"],
        header_patterns: &[],
        nxdomain_vulnerable: false,
        severity: Severity::Medium,
        cvss: 7.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME or attach the domain to a Tave studio.",
    },
    // Pingdom Public Status pages
    ServiceFingerprint {
        name: "Pingdom",
        cname_patterns: &["stats.pingdom.com", ".pingdom.com"],
        http_signatures: &["pingdom"],
        header_patterns: &[],
        nxdomain_vulnerable: false,
        severity: Severity::Medium,
        cvss: 6.5,
        confirmed_exploitable: false,
        remediation: "Remove the CNAME pointing to Pingdom stats pages.",
    },
    // Bigcartel
    ServiceFingerprint {
        name: "Bigcartel",
        ...
        cvss: 8.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME or claim the Big Cartel store name.",
    },
    // Anima — design-to-code hosting.
    ServiceFingerprint {
        name: "Anima",
        cname_patterns: &[".animaapp.io"],
        http_signatures: &["If this is your website and you've just created it"],
        header_patterns: &[],
        nxdomain_vulnerable: false,
        severity: Severity::Medium,
        cvss: 7.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME or attach the domain to an Anima project.",
    },
    // Cargo (Cargo.site portfolios)
    ServiceFingerprint {
        name: "Cargo.site",
        cname_patterns: &[".cargo.site", "subdomain.cargo.site"],
        http_signatures: &["404 Not Found"],
        header_patterns: &[("server", "Cargo")],
        nxdomain_vulnerable: false,
        severity: Severity::Medium,
        cvss: 6.5,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME or attach the domain to a Cargo.site portfolio.",
    },
    // Frontify — brand-portal hosting.
    ServiceFingerprint {
        name: "Frontify",
        cname_patterns: &[".frontify.com"],
        http_signatures: &["This brand guideline doesn't exist"],
        header_patterns: &[],
        nxdomain_vulnerable: false,
        severity: Severity::High,
        cvss: 8.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME or claim the Frontify brand portal.",
    },
    // Canny — feedback portals on custom domains.
    ServiceFingerprint {
        name: "Canny",
    ...
    // Kinsta — application hosting (custom domain attach).
    ServiceFingerprint {
        name: "Kinsta",
        ...
        cvss: 8.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME or add the domain to a Kinsta site.",
    },
    // Render.com
    ServiceFingerprint {
        name: "Render",
        cname_patterns: &[".onrender.com"],
        http_signatures: &["Not Found"],
    ...
    // AWS S3 Bucket Website (additional regions / hosted-zone aliases)
    ServiceFingerprint {
        name: "AWS S3 (regional website endpoint)",
        cname_patterns: &[
        ...
        cvss: 9.0,
        confirmed_exploitable: true,
        remediation: "Recreate the S3 bucket (region-aware) with the dangling name or remove the CNAME.",
    },
    // GitBook — documentation hosting with custom domains.
    ServiceFingerprint {
        name: "GitBook",
        cname_patterns: &["hosting.gitbook.com", "hosting.gitbook.io", ".gitbook.io"],
        http_signatures: &[
            "Domain not found",
            "<title>404</title>",
        ],
        ...
        cvss: 8.0,
        confirmed_exploitable: true,
        remediation: "Remove the CNAME or attach the domain to a GitBook space.",
    },
];
