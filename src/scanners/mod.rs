...
impl ScanEngine {
    ...
    pub async fn execute_scan(
        ...
        if !scan_plan.prioritized_params.is_empty() {
            ...
            // If no parameters discovered, don't guess - skip injection testing
            // Parameters should come from: URL, forms, JavaScript analysis, or API specs
            if test_parameters.is_empty() {
                debug!("[TARGET] No parameters discovered for injection testing on {}", url);
            }
        }
