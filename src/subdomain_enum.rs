...
const EXTENDED_SUBDOMAINS: &[&str] = &[
    ...
    "logs",
    "syslog",
    // Release/rollout naming (often pre-prod with weaker auth)
    "preprod",
    "pre-prod",
    "pre-production",
    "rc",
    ...
    "next",
    "review",
    // Source control / registries (high-impact: code + artifacts)
    "gitea",
    "gogs",
    "harbor",
    "nexus",
    ...
    "npm",
    "maven",
    // CI/CD orchestration (RCE risk on exposed admin)
    "argo",
    "argocd",
    "flux",
    "tekton",
    ...
    "rundeck",
    "octopus",
    // Identity / SSO (token + auth bypass surface)
    "keycloak",
    "okta",
    "auth0",
    "cognito",
    ...
    "ory",
    "casdoor",
    // Secrets / config (highest impact when exposed)
    "vault",
    "consul",
    "nomad",
    "secrets",
    ...
    "bitwarden",
    "1password",
    // Observability (often unauthenticated, leak hostnames/PII)
    "sentry",
    "bugsnag",
    "rollbar",
    "datadog",
    ...
    "fisheye",
    "phabricator",
    // API gateways / service mesh (auth bypass)
    "kong",
    "tyk",
    "apigee",
    "mulesoft",
    ...
    "istio",
    "traefik",
    // Messaging / queues (often unauth admin UIs)
    "rabbitmq",
    "kafka",
    "kafka-ui",
    "nats",
    ...
    "activemq",
    "zookeeper",
    // Mail dev/test catchers (leak transactional content)
    "mailcatcher",
    "mailhog",
    "smtp4dev",
    "inbucket",
    "mailpit",
    // DB admin UIs (direct DB access)
    "phpmyadmin",
    "adminer",
    "pgadmin",
    "mongo-express",
    ...
    "dbeaver",
    "metabase-db",
    // Container/cluster mgmt (cluster takeover)
    "kubernetes",
    "k8s",
    "rancher",
    "openshift",
