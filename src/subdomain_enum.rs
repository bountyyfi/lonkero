...
const EXTENDED_SUBDOMAINS: &[&str] = &[
    ...
    "logs",
    "syslog",
    // ---- Observability / dashboards (frequently exposed with weak/no auth) ----
    "grafana",
    "kibana",
    "prometheus",
    "alertmanager",
    ...
    "nexus",
    "quay",
    // ---- Secret / config stores (extremely high-impact if exposed) ----
    "vault",
    "hashicorp",
    "consul",
    "nomad",
    ...
    "mlflow",
    "kubeflow",
    // ---- Support / knowledge (often contain PII / customer data) ----
    "zendesk",
    "freshdesk",
    "helpscout",
    "servicedesk",
    ...
    "outline",
    "docusaurus",
    // ---- Developer tools / internal ports ----
    "backstage",
    "internal-tools",
    "internaltools",
    "internal-portal",
    ...
    "console",
    "cli",
    // ---- DB admin panels (extreme risk if reachable) ----
    "phpmyadmin",
    "pma",
    "adminer",
    "mongo-express",
    ...
    "sqs",
    "sns",
    // ---- Email / marketing test infrastructure ----
    "mailhog",
    "mailcatcher",
    "mailpit",
    "papercut",
    ...
    "postal",
    "mailtrap",
    // ---- Alt env / preview / review apps (often unauth) ----
    "preview",
    "review",
    "review-app",
    "reviewapp",
    ...
    "ephemeral",
    "feature",
    // ---- Common attacker-favored internal panels ----
    "cockpit",
    "webmin",
    "virtualmin",
    "directadmin",
    ...
    "hasura",
    "postgrest",
    // ---- MFT / file drop (often stores customer files) ----
    "mft",
    "goanywhere",
    "sharefile",
    "wetransfer",
    ...
    "archive",
    "archived",
    // ---- Multi-tenant client dashboards (BOLA/IDOR magnets) ----
    "client",
    "clients",
    "customer",
    "customers",
