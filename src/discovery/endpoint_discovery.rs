...
impl EndpointDiscovery {
    ...
    fn get_wordlist() -> Vec<&'static str> {
        vec![
            ...
            "/throttle",
            // ========================================
            // HIGH-SIGNAL SENSITIVE INFRA ENDPOINTS
            // Well-known paths that, when reachable without auth,
            // indicate an impactful misconfiguration or expose secrets.
            // ========================================
            // Spring Boot actuator (post-2.x lives under /actuator/*)
            "/actuator",
            "/actuator/env",
            "/actuator/env.json",
            "/actuator/configprops",
            ...
            // Legacy Spring actuator paths (Spring Boot 1.x)
            "/env",
            "/env.json",
            "/dump",
            "/trace",
            ...
            "/heapdump",
            "/loggers",
            // Go pprof / expvar (typically bound to /debug/*)
            "/debug/pprof/",
            "/debug/pprof/heap",
            ...
            "/livez",
            "/healthz",
            // etcd (typically :2379/:4001; if fronted by proxy still worth probing)
            "/v2/keys",
            "/v3/kv/range",
            "/version",
            "/metrics",
            // Docker Engine API (dangerous when exposed)
            "/v1.40/info",
            "/v1.40/version",
            ...
            "/v3/settings",
            "/v3/clusters",
            "/v3-public/authProviders",
            // Rundeck / Jenkins / TeamCity
            "/script",
            "/scriptler",
            "/asynchPeople/",
            "/computer/api/json",
            ...
            "/_wdt",
            "/_fragment",
            // Laravel Ignition / Telescope / Horizon / Nova
            ...
            "/rest/gadget/1.0/pickers/projects",
            "/secure/popups/DumpLicense.jspa",
            "/plugins/servlet/gadgets/directory",
            "/wiki/rest/api/content",
            "/wiki/rest/api/space",
            "/wiki/rest/api/user/current",
            // Sitecore / Umbraco / Kentico
            "/sitecore/shell/sitecore.version.xml",
            "/sitecore/service/isalive.aspx",
            "/umbraco/",
            "/umbraco/backoffice/api/health",
            "/Admin/CMSAdministration.aspx",
            "/CMSPages/logon.aspx",
            // GraphQL common introspection paths
            "/graphql",
            "/graphql/console",
            "/graphql-explorer",
            "/graphiql",
            ...
            // AWS/GCP/Azure metadata reachable via SSRF-fronted proxy paths
            // (kept only where the proxy pattern is generic and unlikely to hit a real URL)
            "/latest/meta-data/",
            "/latest/dynamic/instance-identity/document",
            "/computeMetadata/v1/instance/",
            "/metadata/instance",
            "/metadata/identity/oauth2/token",
            // Backup / VCS / IDE / secret file leaks (exact filenames only)
            "/.env",
            "/.env.local",
            "/.env.dev",
            "/.env.development",
            ...
            "/.rediscli_history",
            "/.viminfo",
            // Common backup archive names at web root
            "/backup.zip",
            "/backup.tar",
            "/backup.tar.gz",
            "/backup.tgz",
            ...
            "/dev.sqlite3",
            "/production.sqlite3",
            // Sourcemaps (deanonymize bundled JS)
            "/main.js.map",
            "/app.js.map",
            "/bundle.js.map",
            "/index.js.map",
