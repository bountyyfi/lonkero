...
impl EndpointDiscovery {
    ...
    fn get_wordlist() -> Vec<&'static str> {
        vec![
            ...
            "/throttle",
            // ========================================
            // EXPOSED VCS METADATA (.git/.svn/.hg/CVS)
            // Files chosen are deterministic markers (no false positives
            // from custom 404 pages — content is structurally distinctive).
            // ========================================
            "/.git/HEAD",
            "/.git/config",
            "/.git/index",
            ...
            "/CVS/Root",
            // ========================================
            // ENV / DOTFILES (high-value secret leaks)
            // ========================================
            "/.env",
            "/.env.local",
            "/.env.dev",
            ...
            "/.htaccess",
            // ========================================
            // BACKUP / DUMP FILES IN WEBROOT
            // Common admin-mistake patterns; presence + 200 + reasonable
            // size strongly indicates exposure.
            // ========================================
            "/backup.sql",
            "/backup.sql.gz",
            "/backup.zip",
            ...
            // ========================================
            // SPRING BOOT ACTUATOR (high-impact: env, heapdump, mappings)
            // Both Boot 1.x (/...) and 2.x+ (/actuator/...) layouts.
            // ========================================
            "/actuator",
            "/actuator/health",
            "/actuator/info",
            ...
            "/openapi/v3",
            // ========================================
            // BUILD / CI METADATA LEFT IN WEBROOT
            // ========================================
            "/Dockerfile",
            "/Dockerfile.prod",
            "/docker-compose.yml",
            ...
            // (low FP — exact filenames; reveal stack + CVE surface)
            // ========================================
            "/package.json",
            "/package-lock.json",
            "/yarn.lock",
            ...
            // ========================================
            // ADMIN UIs commonly exposed on internet
            // ========================================
            "/pgadmin/",
            "/pgadmin4/",
            "/rockmongo/",
            ...
            "/_profiler",
            "/_profiler/phpinfo",
            "/_profiler/info/parameter",
            "/_profiler/empty/search/results",
            "/_wdt",
            "/symfony/profiler",
            "/silent_login",
            // ========================================
            // SWAGGER / API SCHEMAS (exact files only)
            // ========================================
            "/swagger.json",
            "/swagger.yaml",
            ...
            // ========================================
            // ROBOTS / SITEMAP / CRAWLER HINTS
            // (Cheap but high-value: robots.txt often discloses staging paths)
            // ========================================
            "/robots.txt",
            "/humans.txt",
            "/sitemap.xml",
            ...
            "/app-ads.txt",
            // ========================================
            // ASP.NET / IIS specific high-value paths
            // ========================================
            "/trace.axd",
            "/elmah.axd",
            "/glimpse.axd",
